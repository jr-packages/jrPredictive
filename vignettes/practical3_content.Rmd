...
\noindent A logistic regression model is typically not suitable for more than $2$ classes, so try fitting the other models using a training set that consists of 90\% of the available data. Hint: The function `createDataPartition` can be used here, see notes for a reminder.
